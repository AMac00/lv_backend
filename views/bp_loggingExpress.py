...
# User Namespace
api = Namespace('logs_express', description='Onc Click Log collection related operations')
...
bp_logs_param = api.model("LoggingExpress",
               {
                  "log_option": fields.String(description="Outage type for one click log collection", required=True)
               })
...
class logs(Resource):
    ...
    def post(selfs):
        ...
        __results__ = __fun_logging__.api_loggingExpress_pull(__info__)
